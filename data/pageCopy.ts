...
export const heroCopy = {
  ...
  secondaryBody: [
    "Bez izolētām reklāmām.",
    "Bez izklājlapām kā galvenās sistēmas.",
    "Bez modes vārdiem, kas neko nemaina.",
    "Tikai komerciāla infrastruktūra, kas dzīvo ikdienā un kļūst precīzāka katru mēnesi."
  ],
  microcopy: "30-min saruna · sākuma audits · skaidra atbilde, vai sistēma ir vajadzīga"
};
...
export const sectionCopy = {
  ...
  clarity: {
    eyebrow: "09 · SKAIDRĪBA",
    headline: "Pirms tu jautā.",
    body: "Sešas atbildes uz jautājumiem, kurus parasti uzdod pirmajā sarunā."
  },
  audits: {
    eyebrow: "10 · AUDITS",
