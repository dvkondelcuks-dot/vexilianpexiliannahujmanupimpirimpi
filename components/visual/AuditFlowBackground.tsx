  ...
  return (
    <Box ref={ref} aria-hidden="true" sx={{ position: "absolute", inset: 0, pointerEvents: "none", opacity: 0.55 }}>
      <svg viewBox="0 0 980 620" style={{ width: "100%", height: "100%" }} preserveAspectRatio="xMidYMid slice">
        ...
        {/* decay then recover curve */}
        <path className="audit-trace" d="M20 200 C160 220 220 380 360 380 C500 380 560 320 700 300 C800 286 860 260 960 230" fill="none" stroke={CHART.amber} strokeOpacity={0.55} strokeWidth={1.4} />
        <path className="audit-trace" d="M20 320 C180 326 260 420 420 420 C580 420 660 360 820 348 C900 342 940 338 960 336" fill="none" stroke={CHART.lime} strokeOpacity={0.45} strokeWidth={1.4} strokeDasharray="6 6" />
        {/* axis ticks bottom */}
