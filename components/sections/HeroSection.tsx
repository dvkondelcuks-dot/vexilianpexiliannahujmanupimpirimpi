...
export function HeroSection() {
  ...
  return (
    <SectionShell id="manifest" sx={{ pt: { xs: 0.25, md: 0.5 }, pb: { xs: 5, md: 5 } }}>
      <Stack spacing={2} data-reveal-stagger sx={{ mb: { xs: 2.5, md: 3 } }}>
        <Typography
          component="h1"
          variant="h1"
          data-reveal="up"
          sx={{
            fontSize: { xs: "2.4rem", sm: "3.4rem", md: "4.6rem", lg: "5.4rem", xl: "6.4rem" },
            lineHeight: 1.08,
